...
<div class="wrap">
    <h2>Add New Taxonomy
        <a href="?page=wwm-taxonomies" class="add-new-h2"><?php _e('Back To Taxonomies List') ?></a>
    </h2>
    <p></p>
            ...
            <div id="col-left" class="wwm-taxonomy-col-left">
                <div class="col-wrap">
                    ...
                    <div class="form-field form-required term-name-wrap">
                        ...
                        <input name="taxonomy-name" type="text" id="taxonomy-name" value="<?php echo $taxonomy->getTaxonomy();?>" aria-required="true" data-dependent-fields="taxonomy-query_var|rewrite-slug">
                    </div>
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="taxonomy-object_type" type="text" id="taxonomy-object_type" value="<?php echo $taxonomy->getObjectType();?>">
                    </div>
                    <div class="form-field term-name-wrap">
                        ...
                        <input name="taxonomy-hierarchical" type="checkbox" value="1" id="taxonomy-public" <?php if($taxonomy->isHierarchical()){echo "checked";}?>>
                    </div>
                    <div class="form-field term-name-wrap">
                        ...
                        <input name="taxonomy-public" type="checkbox" value="1" id="taxonomy-public" checked <?php if($taxonomy->isPublic()){echo "checked";}?>>
                    </div>
                    ...
                    <div class="hidden" id="sub-params">
                        ...
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="taxonomy-show_ui" type="checkbox" value="1" id="taxonomy-show_ui" <?php if($taxonomy->getShowUi()){echo "checked";}?>>
                        </div>
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="taxonomy-show_in_menu" type="checkbox" value="1" id="taxonomy-show_in_menu" <?php if($taxonomy->getShowInMenu()){echo "checked";}?>>
                        </div>
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="taxonomy-show_in_nav_menus" type="checkbox" value="1" id="taxonomy-show_in_nav_menus" <?php if($taxonomy->getShowInNavMenus()){echo "checked";}?>>
                        </div>
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="taxonomy-show_tagcloud" type="checkbox" value="1" id="taxonomy-show_tagcloud" <?php if($taxonomy->getShowTagCloud()){echo "checked";}?>>
                        </div>
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="taxonomy-show_in_quick_edit" type="checkbox" value="1" id="taxonomy-show_in_quick_edit" <?php if($taxonomy->getShowInQuickEdit()){echo "checked";}?>>
                        </div>
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="taxonomy-show_admin_column" type="checkbox" value="1" id="taxonomy-show_admin_column" <?php if($taxonomy->isShowAdminColumn()){echo "checked";}?> >
                        </div>
                        <div class="form-field term-name-wrap ">
                            ...
                            <input name="taxonomy-meta_box_cb" type="text" id="taxonomy-meta_box_cb" placeholder="default null" value="<?php echo $taxonomy->getMetaBoxCb();?>">
                        </div>
                        <div class="form-field term-name-wrap ">
                            ...
                            <input name="taxonomy-query_var" type="text" id="taxonomy-query_var" placeholder="Default value taxonomy name" value="<?php echo $taxonomy->getQueryVar();?>">
                        </div>
                        <div class="form-field term-name-wrap ">
                            ...
                            <input name="taxonomy-update_count_callback" type="text" id="taxonomy-update_count_callback" placeholder="default null" value="<?php echo $taxonomy->getUpdateCountCallback();?>">
                        </div>
                        <div class="form-field term-name-wrap">
                            <label for="taxonomy-description">Description<span class="description"></span></label>
                            <div><small>A short descriptive summary of what the post type is</small></div>
                            <input name="taxonomy-description" type="text" id="taxonomy-description" value="<?php echo $taxonomy->getDescription();?>">
                        </div>
                    </div>
                    <hr>
                </div>
            ...
            <div id="col-right" class="wwm-taxonomy-col-right">
                <div class="col-wrap">
                    ...
                    <div class="form-field form-required term-name-wrap">
                        ...
                        <input name="labels[name]" type="text" id="label-name" value="<?php echo $taxonomy->getLabels()['name'];?>" aria-required="true">
                    ...
                    <div class="args-labels wp-clearfix hidden" id="args-labels">
                        <div id="col-left">
                            <div class="form-field term-name-wrap">
                                <label for="label-singular_name]">singular_name<span class="description"></span></label>

                                <div>
                                    <small>name for one object of this taxonomy.</small>
                                </div>
                                <input name="labels[singular_name]" type="text" id="label-singular_name" value="<?php echo $taxonomy->getLabels()['singular_name'];?>">

                            </div>
                            <div class="form-field term-name-wrap">
                                <label for="label-menu_name">menu_name<span class="description"></span></label>
                                <div><small>the menu name text.</small></div>
                                <input name="labels[menu_name]" type="text" id="label-menu_name" value="<?php echo $taxonomy->getLabels()['menu_name']?>">

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-all_items">add_new_item<span class="description"></span></label>
                                <div><small>the all items text.</small></div>
                                <input name="labels[all_items]" type="text" id="label-all_items" value="<?php echo $taxonomy->getLabels()['all_items'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-edit_item">edit_item<span class="description"></span></label>
                                <div><small>the edit item text.</small></div>
                                <input name="labels[edit_item]" type="text" id="label-edit_item" value="<?php echo $taxonomy->getLabels()['edit_item'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-view_item">view_item<span class="description"></span></label>
                                <div>
                                    <small>the view item text</small>
                                </div>
                                <input name="labels[view_item]" type="text" id="label-view_item" value="<?php echo $taxonomy->getLabels()['view_item'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-update_item">update_item<span class="description"></span></label>
                                <div>
                                    <small>he update item text</small>
                                </div>
                                <input name="labels[update_item]" type="text" id="label-update_item" value="<?php echo $taxonomy->getLabels()['update_item'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-add_new_item">add_new_item<span class="description"></span></label>
                                <div>
                                    <small>the add new item text.</small>
                                </div>
                                <input name="labels[add_new_item]" type="text" id="label-add_new_item" value="<?php echo $taxonomy->getLabels()['add_new_item'];?>" >

                            </div>

                            <div class="form-field  term-name-wrap">
                                <label for="label-new_item_name">new_item_name<span class="description"></span></label>
                                <div>
                                    <small>the new item name text.</small>
                                </div>
                                <input name="labels[new_item_name]" type="text" id="label-new_item_name" value="<?php echo $taxonomy->getLabels()['new_item_name'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-parent_item">parent_item<span class="description"></span></label>

                                <div>
                                    <small>the parent item text. This string is not used on non-hierarchical taxonomies such as post tags.</small>
                                </div>
                                <input name="labels[parent_item]" type="text" id="label-parent_item" value="<?php echo $taxonomy->getLabels()['parent_item'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-parent_item_colon">parent_item_colon<span class="description"></span></label>

                                <div>
                                    <small>The same as parent_item, but with colon</small>
                                </div>
                                <input name="labels[parent_item_colon]" type="text" id="label-parent_item_colon" value="<?php echo $taxonomy->getLabels()['parent_item_colon'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-not_found">not_found<span class="description"></span></label>

                                <div>
                                    <small>the text used in the terms list table when there are no items for a taxonomy.</small>
                                </div>
                                <input name="labels[not_found]" type="text" id="label-not_found" value="<?php echo $taxonomy->getLabels()['not_found']?>" >
                        ...
                        <div id="col-right">
                            <div class="form-field  term-name-wrap">
                                <label for="label-search_items">search_items<span class="description"></span></label>

                                <div>
                                    <small>the search items text.</small>
                                </div>
                                <input name="labels[search_items]" type="text" id="label-search_items" value="<?php echo $taxonomy->getLabels()['search_items'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-popular_items">popular_items<span class="description"></span></label>

                                <div>
                                    <small>the popular items text. This string is not used on hierarchical taxonomies.</small>
                                </div>
                                <input name="labels[popular_items]" type="text" id="label-popular_items" value="<?php echo $taxonomy->getLabels()['popular_items'];?>" >
                            ...
                            <div class="form-field  term-name-wrap">
                                ...
                                <input name="labels[separate_items_with_commas]" type="text" id="label-separate_items_with_commas" value="<?php echo $taxonomy->getLabels()['separate_items_with_commas'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-add_or_remove_items">add_or_remove_items<span class="description"></span></label>
                                ...
                                <input name="labels[add_or_remove_items]" type="text" id="label-add_or_remove_items" value="<?php echo $taxonomy->getLabels()['add_or_remove_items'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-choose_from_most_used">choose_from_most_used<span class="description"></span></label>
                                ...
                                <input name="labels[choose_from_most_used]" type="text" id="label-choose_from_most_used" value="<?php echo $taxonomy->getLabels()['choose_from_most_used'];?>" >
                            ...
                            <div class="form-field  term-name-wrap">
                                ...
                                <input name="labels[no_terms]" type="text" id="label-no_terms" value="<?php echo $taxonomy->getLabels()['no_terms'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-items_list_navigation">items_list_navigation<span class="description"></span></label>

                                <div>
                                    <small>String for the table pagination hidden heading.</small>
                                </div>
                                <input name="labels[items_list_navigation]" type="text" id="label-items_list_navigation" value="<?php echo $taxonomy->getLabels()['items_list_navigation'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-items_list">items_list<span class="description"></span></label>
                                <div>
                                    <small>String for the table hidden heading.</small>
                                </div>
                                <input name="labels[items_list]" type="text" id="label-items_list" value="<?php echo $taxonomy->getLabels()['items_list'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-name_admin_bar">name_admin_bar<span class="description"></span></label>

                                <div>
                                    <small>String for use in New in Admin menu bar.</small>
                                </div>
                                <input name="labels[name_admin_bar]" type="text" id="label-name_admin_bar" value="<?php echo $taxonomy->getLabels()['name_admin_bar'];?>" >

                            </div>
                            <div class="form-field  term-name-wrap">
                                <label for="label-archives">archives<span class="description"></span></label>

                                <div>
                                    <small>String for use with archives in nav menus.</small>
                                </div>
                                <input name="labels[archives]" type="text" id="label-archives" value="<?php echo $taxonomy->getLabels()['archives'];?>" >
                    ...
                    <div class="form-field form-required term-name-wrap">
                        ...
                        <input name="rewrite[slug]" type="text" id="rewrite-slug" value="<?php echo
$taxonomy->getRewrite()['slug'];?>" aria-required="true">
                    ...
                    <div class="form-field term-name-wrap">
                        ...
                        <input name="rewrite[with_front]" type="checkbox" value="1" id="rewrite-with_front"  <?php if($taxonomy->getRewrite()['with_front']){echo "checked";}?>>

                    </div>
                    <div class="form-field term-name-wrap">
                        <label for="rewrite-hierarchical">hierarchical </label>
                        <div><small> true or false allow hierarchical urls</small></div>
                        <input name="rewrite[hierarchical]" type="checkbox" value="1"  id="rewrite-hierarchical" <?php if($taxonomy->getRewrite()['hierarchical']){echo "checked";}?>>
                    </div>
