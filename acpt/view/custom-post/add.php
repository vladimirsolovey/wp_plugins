            ...
            <div class="col-wrap">
                ...
                <div class="section-body">
                    <div class="form-field form-required term-name-wrap">
                        ...
                        <input name="post-type-name" type="text" id="post-type-name" value="" aria-required="true" data-dependent-fields="rewrite-slug">
                    </div>
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-taxonomies" type="text" id="post-type-taxonomies">
                    </div>
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-menu_position" type="number" id="post-type-menu_position" placeholder="default null (at the bottom)">
                    </div>
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-menu_icon" type="text" id="post-type-menu_icon" placeholder="defaults to use the post icon">
                    </div>
                    ...
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-supports" type="text" id="post-type-supports" placeholder="default (title,editor)">
                    </div>
                    <div class="form-field term-name-wrap">
                        <label for="post-type-public">
                            <input name="post-type-public" type="checkbox" value="1" id="post-type-public" checked>
                ...
                <div class="hidden" id="sub-params">
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-capability_type" type="text" id="post-type-capability_type" placeholder="default 'post'">
                    </div>
                    <div class="form-field term-name-wrap">
                        ...
                        <input name="post-type-description" type="text" id="post-type-description" value="">
                    </div>

                    <div class="form-field term-name-wrap">
                        <label for="post-type-hierarchical">
                            <input name="post-type-hierarchical" type="checkbox" value="1" id="post-type-public" >
                    ...
                    <div class="form-field term-name-wrap">
                        <label for="post-type-exclude_from_search">
                            <input name="post-type-exclude_from_search" type="checkbox" value="1" id="post-type-exclude_from_search" >
                    ...
                    <div class="form-field term-name-wrap">
                        <label for="post-type-publicly_queryable">
                            <input name="post-type-publicly_queryable" type="checkbox" value="1" id="post-type-publicly_queryable" >
                    ...
                    <div class="form-field term-name-wrap">
                        <label for="post-type-show_ui">
                            <input name="post-type-show_ui" type="checkbox" value="1" id="post-type-show_ui" checked>
                            Use UI in Admin<span class="description"></span>-<span class="acpt-param-item">[show_ui]</span></label>
                        <div class="small-param-info">Whether to generate and allow a UI for managing this post type in the admin</div>

                    </div>
                    <div class="form-field term-name-wrap">
                        <label for="post-type-show_in_menu">
                            <input name="post-type-show_in_menu" type="checkbox" value="1" id="post-type-show_in_menu" checked>
                    ...
                    <div class="form-field term-name-wrap">
                        <label for="post-type-show_in_nav_menu">
                            <input name="post-type-show_in_nav_menu" type="checkbox" value="1" id="post-type-show_in_nav_menu" checked>
                    ...
                    <div class="form-field term-name-wrap">
                        <label for="post-type-show_in_admin_bar">
                            <input name="post-type-show_in_admin_bar" type="checkbox" value="1" id="post-type-show_in_admin_bar" >
                    ...
                    <div class="form-field term-name-wrap">
                        <label for="post-type-map_meta_cap">
                            <input name="post-type-map_meta_cap" type="checkbox" value="1" id="post-type-map_meta_cap" >
                    ...
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-register_meta_box_cb" type="text" id="post-type-register_meta_box_cb" placeholder="default null">
                    </div>

                    <div class="form-field term-name-wrap ">
                        <label for="post-type-has_archive">
                            <input name="post-type-has_archive" type="checkbox" value="1" id="post-type-has_archive" checked>
                    ...
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-query_var" type="text" id="post-type-query_var" value="" placeholder="Default value true" checked>
                    </div>
                    <div class="form-field term-name-wrap ">
                        <label for="post-type-can_export">
                            <input name="post-type-can_export" type="checkbox" value="1" id="post-type-can_export">
                    ...
                    <div class="form-field term-name-wrap ">
                        <label for="post-type-delete_with_user">
                            <input name="post-type-delete_with_user" type="checkbox" value="1" id="post-type-delete_with_user">
                    ...
                    <div class="form-field term-name-wrap ">
                        <label for="post-type-builtin">
                            <input name="post-type-builtin" type="checkbox" value="1" id="post-type-builtin">
                    ...
                    <div class="form-field term-name-wrap ">
                        ...
                        <input name="post-type-edit_link" type="text" id="post-type-edit_link" value="" placeholder="Default 'post.php?post=%d'">
                    </div>
                    <hr>
                </div>
            ...
            <div class="col-wrap">
                ...
                <div class="args-labels hidden" id="args-labels">
                    <div id="col-left">
                        ...
                        <div class="form-field term-name-wrap">
                            ...
                            <input name="labels[add_new]" type="text" id="label-add_new" value="">
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[new_item]" type="text" id="label-new_item" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[view_items]" type="text" id="label-view_items" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[not_found_in_trash]" type="text" id="label-not_found_in_trash" value="" >
                    ...
                    <div id="col-right">
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[attributes]" type="text" id="label-attributes" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[insert_into_item]" type="text" id="label-insert_into_item" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[uploaded_to_this_item]" type="text" id="label-uploaded_to_this_item" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[featured_image]" type="text" id="label-featured_image" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[set_featured_image]" type="text" id="label-set_featured_image" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[remove_featured_image]" type="text" id="label-remove_featured_image" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[use_featured_image]" type="text" id="label-use_featured_image" value="" >
                        ...
                        <div class="form-field  term-name-wrap">
                            ...
                            <input name="labels[filter_items_list]" type="text" id="label-filter_items_list" value="" >
                ...
                <div class="form-field term-name-wrap">
                   <label for="rewrite[feeds]">
                       <input name="rewrite[feeds]" type="checkbox" value="1"  id="rewrite-feeds" checked>
                ...
                <div class="form-field term-name-wrap">
                    ...
                    <label for="rewrite[pages]">
                        <input name="rewrite[pages]" type="checkbox" value="1"  id="rewrite-pages" checked>
